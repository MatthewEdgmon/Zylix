...
void LoadCR0(uint32_t);
void LoadCR1(uint32_t);
void LoadCR2(uint32_t);
void LoadCR3(uint32_t);
void LoadCR4(uint32_t);
void LoadCR5(uint32_t);
void LoadCR6(uint32_t);
void LoadCR7(uint32_t);
void LoadCR8(uint32_t);
void LoadCR9(uint32_t);
void LoadCR10(uint32_t);
void LoadCR11(uint32_t);
void LoadCR12(uint32_t);
void LoadCR13(uint32_t);
void LoadCR14(uint32_t);
void LoadCR15(uint32_t);

uint32_t SaveCR0(void);
uint32_t SaveCR1(void);
uint32_t SaveCR2(void);
uint32_t SaveCR3(void);
uint32_t SaveCR4(void);
uint32_t SaveCR5(void);
uint32_t SaveCR6(void);
uint32_t SaveCR7(void);
uint32_t SaveCR8(void);
uint32_t SaveCR9(void);
uint32_t SaveCR10(void);
uint32_t SaveCR11(void);
uint32_t SaveCR12(void);
uint32_t SaveCR13(void);
uint32_t SaveCR14(void);
uint32_t SaveCR15(void);

uint32_t GetFlagRegister(void);
