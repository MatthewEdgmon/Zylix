...
#define ATA_STATUS_BIT_IDX  1
#define ATA_STATUS_BIT_CORR 2
...
#define ATA_DEVICE_NONE    0
#define ATA_DEVICE_UNKNOWN 1
#define ATA_DEVICE_PATAPI  2
#define ATA_DEVICE_SATAPI  3
#define ATA_DEVICE_PATA    4
#define ATA_DEVICE_SATA    5
