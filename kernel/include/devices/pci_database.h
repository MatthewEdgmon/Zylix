 ...
 *
 *  This header created on Sun May 15 13:51:31 EDT 2016
 *
...
#ifndef __PCI_DATABASE_H__
#define __PCI_DATABASE_H__

typedef struct {
	uint16_t vendor_id;
	char*    vendor_string_short;
	char*    vendor_string_full;
}  pci_vendor_table_entry_t;

pci_vendor_table_entry_t pci_vendor_table[] = {
...
#define	PCI_VENDOR_TABLE_LENGTH (sizeof(pci_vendor_table)/sizeof(pci_vendor_table_entry_t))
...
} pci_device_table_entry_t;

pci_device_table_entry_t pci_device_table[] = {
...
//	{ 0x0553, 0x0200, 0x0201, 0x02, "DS38xx", "Oregon Scientific" },
	...
	{ 0x168C, 0x0030, "PCI\\VEN_168C&DEV_0030&SUBSYS_16A810CF&REV_01", "TP-LINK 450Mbps Wireless N Adapter" },
...
#define	PCI_DEVICE_TABLE_LENGTH (sizeof(pci_device_table)/sizeof(pci_device_table_entry_t))
...
} pci_class_code_table_entry_t;

pci_class_code_table_entry_t pci_class_code_table[] = {
    ...
    { 0x01, 0x07, 0x00, "Mass Storage Controller", "SAS", "" },
	...
	{ 0x02, 0x05, 0x00, "Network Controller", "WorldFip", "" },
	...
	{ 0x03, 0x02, 0x00, "Display Controller", "3D (Not VGA-Compatible)", "" },
	...
	{ 0x06, 0x09, 0x40, "Bridge Device", "PCI/PCI (Semi-Transparent, Primary)", "" },
	{ 0x06, 0x09, 0x80, "Bridge Device", "PCI/PCI (Semi-Transparent, Secondary)", "" },
	...
	{ 0x07, 0x02, 0x00, "Simple Communications Controller", "Serial", "Multiport Serial Controller" },
	{ 0x07, 0x03, 0x00, "Simple Communications Controller", "Generic Modem", "" },
	{ 0x07, 0x03, 0x01, "Simple Communications Controller", "Hayes Compatible Modem", "(16450-Compatible Interface)" },
	{ 0x07, 0x03, 0x02, "Simple Communications Controller", "Hayes Compatible Modem", "(16550-Compatible Interface)" },
	{ 0x07, 0x03, 0x03, "Simple Communications Controller", "Hayes Compatible Modem", "(16650-Compatible Interface)" },
	{ 0x07, 0x03, 0x04, "Simple Communications Controller", "Hayes Compatible Modem", "(16750-Compatible Interface)" },
	...
	{ 0x07, 0x80, 0x00, "Simple Communications Controller", "Other", "" },
	...
	{ 0x08, 0x00, 0x10, "Base Systems Peripheral", "PIC (Programmable Interrupt Controller)", "I/O APIC" },
	{ 0x08, 0x00, 0x20, "Base Systems Peripheral", "PIC (Programmable Interrupt Controller)", "I/O(X) APIC" },
	{ 0x08, 0x01, 0x00, "Base Systems Peripheral", "DMA (Direct Memory Access)", "Generic 8237/8259" },
	...
	{ 0x08, 0x02, 0x00, "Base Systems Peripheral", "System Timer", "Generic 8254/8259" },
	...
	{ 0x09, 0x04, 0x00, "Input Device", "Gameport", "Generic" },
	{ 0x09, 0x04, 0x10, "Input Device", "Gameport", "Legacy" },
	...
	{ 0x0C, 0x03, 0x00, "Serial Bus Controller", "USB", "(Universal Host Controller)" },
	{ 0x0C, 0x03, 0x10, "Serial Bus Controller", "USB", "(Open Host Controller)" },
	{ 0x0C, 0x03, 0x20, "Serial Bus Controller", "USB", "(Intel Enhanced Host Controller)" },
	{ 0x0C, 0x03, 0x30, "Serial Bus Controller", "USB", "(Extensible Host Controller Interface)" },
	{ 0x0C, 0x03, 0x80, "Serial Bus Controller", "USB", "(Open Host Controller)" },
	{ 0x0C, 0x03, 0xFE, "Serial Bus Controller", "USB", "(Non Host Controller)" },
	...
	{ 0x0C, 0x07, 0x01, "Serial Bus Controller", "IPMI Keyboard Controller Style Interface", "" },
    ...
    { 0x0D, 0x00, 0x00, "Wireless Controllers", "iRDA Compatible Controller", "" },
    { 0x0D, 0x01, 0x00, "Wireless Controllers", "Consumer IR Controller", "" },
    { 0x0D, 0x10, 0x00, "Wireless Controllers", "RF Controller", "" },
    { 0x0D, 0x11, 0x00, "Wireless Controllers", "Bluetooth Controller", "" },
    { 0x0D, 0x12, 0x00, "Wireless Controllers", "Broadband Controller", "" },
    { 0x0D, 0x20, 0x00, "Wireless Controllers", "Ethernet Controller (802.11a)", "" },
    { 0x0D, 0x21, 0x00, "Wireless Controllers", "Ethernet Controller (802.11b)", "" },
    { 0x0D, 0x80, 0x00, "Wireless Controllers", "Other Wireless Controller", "" },

    { 0x0E, 0x00, 0x00, "Intelligent I/O Controllers", "I20 Architecture", "" },
    { 0x0E, 0x00, 0x00, "Intelligent I/O Controllers", "Message FIFO", "" },

    { 0x0F, 0x01, 0x00, "Satellite Communication Controllers", "TV Controller", "" },
    { 0x0F, 0x02, 0x00, "Satellite Communication Controllers", "Audio Controller", "" },
    { 0x0F, 0x03, 0x00, "Satellite Communication Controllers", "Voice Controller", "" },
    { 0x0F, 0x04, 0x00, "Satellite Communication Controllers", "Data Controller", "" },

    { 0x10, 0x00, 0x00, "Encryption/Decryption Controllers", "Network and Computing", "" },
    { 0x10, 0x10, 0x00, "Encryption/Decryption Controllers", "Network and Computing", "" },
    { 0x10, 0x80, 0x00, "Encryption/Decryption Controllers", "Other", "" },

    { 0x11, 0x00, 0x00, "Data Acquisition and Signal Processing Controllers", "DPIO Modules", "" },
    { 0x11, 0x01, 0x00, "Data Acquisition and Signal Processing Controllers", "Performance Counters", "" },
    { 0x11, 0x10, 0x00, "Data Acquisition and Signal Processing Controllers", "Communications Synchronization Plus Time and Frequency Test/Measurment", "" },
    { 0x11, 0x20, 0x00, "Data Acquisition and Signal Processing Controllers", "Management Card", "" },
    { 0x11, 0x80, 0x00, "Data Acquisition and Signal Processing Controllers", "Other Controller", "" },

	{ 0xFF, 0x00, 0x00, "Unknown", "Device Does Not Fit In Class Codes", "UDF" },
};

#define	PCI_CLASS_CODE_TABLE_LENGTH (sizeof(pci_class_code_table)/sizeof(pci_class_code_table_entry_t))

char* pci_command_flags[] = {
	"I/O Access",
	"Memory Access",
	"Bus Mastering",
	"Special Cycles",
...
#define	PCI_COMMAND_FLAGS_LENGTH (sizeof(pci_command_flags)/sizeof(char*))

char* pci_status_flags[] = {
	"Reserved 0",
	"Reserved 1",
	"Reserved 2",
	"Reserved 3",
...
#define	PCI_STATUS_FLAGS_LENGTH (sizeof(pci_status_flags)/sizeof(char*))

char* pci_devsel_flags [] = {
...
#define	PCI_DEVSEL_FLAGS_LEN	(sizeof(pci_devsel_flags)/sizeof(char*))

#endif /* __PCI_DATABASE_H__ */
